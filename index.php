...
function et($tag){
   ...
   // Albanian - by Vilson Bujaj
    $et['sq']['Version'] = 'Versioni';
    $et['sq']['DocRoot'] = 'Dokument Root';
    $et['sq']['FMRoot'] = 'File Manager Root';
    $et['sq']['Name'] = 'Emri';
    $et['sq']['And'] = 'e';
    $et['sq']['Enter'] = 'Futni';
    $et['sq']['Send'] = 'Dergo';
    $et['sq']['Refresh'] = 'Axhurnoj';
    $et['sq']['SaveConfig'] = 'Ruaji Konfigurimet';
    $et['sq']['SavePass'] = 'Ruaj Passwordin';
    $et['sq']['SaveFile'] = 'Ruaj File-in';
    $et['sq']['Save'] = 'Ruaj';
    $et['sq']['Leave'] = 'Braktis';
    $et['sq']['Edit'] = 'Modifiko';
    $et['sq']['View'] = 'Shiko';
    ...
    $et['sq']['Move'] = 'Zhvendos';
    $et['sq']['Copy'] = 'Kopjo';
    $et['sq']['ServerInfo'] = 'Informacione te Serverit';
    $et['sq']['CreateDir'] = 'Krijo Directory';
    $et['sq']['CreateArq'] = 'Krijo File';
    $et['sq']['ExecCmd'] = 'Ekzekuto Komanden';
    $et['sq']['Upload'] = 'Ngarko';
    $et['sq']['UploadEnd'] = 'Ngarkimi perfundoi';
    $et['sq']['Perm'] = 'Leje';
    $et['sq']['Perms'] = 'Lejet';
    $et['sq']['Owner'] = 'Pronar';
    $et['sq']['Group'] = 'Grupi';
    $et['sq']['Other'] = 'Tjere';
    $et['sq']['Size'] = 'Dimensionet';
    $et['sq']['Date'] = 'Data';
    $et['sq']['Type'] = 'Tipi';
    $et['sq']['Free'] = 'te lira';
    $et['sq']['Shell'] = 'Shell';
    $et['sq']['Read'] = 'Lexim';
    $et['sq']['Write'] = 'Shkrim';
    $et['sq']['Exec'] = 'Ekzekutime';
    $et['sq']['Apply'] = 'Apliko';
    $et['sq']['StickyBit'] = 'Bit Ngjitëse';
    $et['sq']['Pass'] = 'Pasword';
    $et['sq']['Lang'] = 'Gjuha';
    $et['sq']['File'] = 'File';
    $et['sq']['File_s'] = 'file';
    $et['sq']['Dir_s'] = 'directory';
    $et['sq']['To'] = 'tek';
    $et['sq']['Destination'] = 'Destinazione';
    $et['sq']['Configurations'] = 'Konfigurime';
    $et['sq']['JSError'] = 'Gabim JavaScript';
    $et['sq']['NoSel'] = 'Nuk ka elemente te selektuar';
    $et['sq']['SelDir'] = 'Zgjidh direktorine e mberritjes';
    $et['sq']['TypeDir'] = 'Vendos emrin e direktorise';
    $et['sq']['TypeArq'] = 'Vendos emrin e file-it';
    $et['sq']['TypeCmd'] = 'Vendos komanden';
    $et['sq']['TypeArqComp'] = 'Vendos emrin e file-it.\\nEkstensioni do te percaktoje tipin e paketimit.\\nShembull:\\nemri.zip\\nemri.tar\\nemri.bzip\\nemri.gzip';
    $et['sq']['RemSel'] = 'FSHIJ elementet e selektuar';
    $et['sq']['NoDestDir'] = 'Direktoria e mberritjes nuk eshte percaktuar';
    $et['sq']['DestEqOrig'] = 'Direktoria e origjines eshte e njejta me te mberritjes';
    $et['sq']['InvalidDest'] = 'Direktoria e mberritjes nuk eshte e vlefshme';
    $et['sq']['NoNewPerm'] = 'Lejet e reja nuk jane aplikuar';
    $et['sq']['CopyTo'] = 'KOPJO ne';
    $et['sq']['MoveTo'] = 'ZHVENDOS ne';
    $et['sq']['AlterPermTo'] = 'NDERRO LEJET: ';
    $et['sq']['ConfExec'] = 'Konfirmoj EKZEKUTIMIN';
    $et['sq']['ConfRem'] = 'Konfirmoj FSHIRJEN';
    $et['sq']['EmptyDir'] = 'Direktoria bosh';
    $et['sq']['IOError'] = 'Gabim i I/O';
    $et['sq']['FileMan'] = 'PHP File Manager';
    $et['sq']['TypePass'] = 'Futni paswordin';
    $et['sq']['InvPass'] = 'Paswordi nuk eshte i sakte';
    $et['sq']['ReadDenied'] = 'Leja e leximit e ndaluar';
    $et['sq']['FileNotFound'] = 'File-i nuk u gjet';
    $et['sq']['AutoClose'] = 'Mbydh dirtaren ne perfundim';
    $et['sq']['OutDocRoot'] = 'File pertej DOCUMENT_ROOT';
    $et['sq']['NoCmd'] = 'Gabim: Komandoja e pa informuar';
    $et['sq']['ConfTrySave'] = 'File pa leje shkrimi.\\nProvo ta ruash gjithsesi';
    $et['sq']['ConfSaved'] = 'Konfigurimi u ruajt';
    $et['sq']['PassSaved'] = 'Paswordi u ruajt';
    $et['sq']['FileDirExists'] = 'Il file o la directory esiste già';
    $et['sq']['NoPhpinfo'] = 'Funksioni phpinfo eshte bllokuar';
    $et['sq']['NoReturn'] = 'pa Return';
    $et['sq']['FileSent'] = 'File-i u dergu';
    $et['sq']['SpaceLimReached'] = 'kufiri i hapesires ne dispozicion eshte arritur';
    $et['sq']['InvExt'] = 'Ekstensioni nuk eshte i vlefshem';
    $et['sq']['FileNoOverw'] = 'File-i nuk mund te mbishkruhet';
    $et['sq']['FileOverw'] = 'File mbishkruar';
    $et['sq']['FileIgnored'] = 'File ndaluar';
    $et['sq']['ChkVer'] = 'Kontrolloni nese nje version i ri eshte i disponueshem';
    $et['sq']['ChkVerAvailable'] = 'eshte i disponueshem nje version i ri: kliko ketu per ta shkarkuar.';
    $et['sq']['ChkVerNotAvailable'] = 'Nuk disponohet asnje version i ri. :(';
    $et['sq']['ChkVerError'] = 'Gabim ne lidhje.';
    $et['sq']['Website'] = 'Siti Web';
    $et['sq']['SendingForm'] = 'Dergimi i file-it, ju lutem prisni';
    ...
    $et['sq']['Total'] = 'totali';
    $et['sq']['Partition'] = 'Particion';
    $et['sq']['RenderTime'] = 'Koha per te perpunuar kete faqe';
    $et['sq']['Seconds'] = 'sek';
    $et['sq']['ErrorReport'] = 'Error Reporting';
